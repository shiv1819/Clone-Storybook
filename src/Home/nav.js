    ...
    <div className="nav-main">
        <div class="nav-left">
            <div class="nav-item phone-item">
                <div class="nav-logo">
                    <svg viewBox="0 0 100 20" fill="none" xmlns="http://www.w3.org/2000/svg" role="presentation"
                        class="css-1r6i2mo e1skfx029">
            ...
            <div class="nav-item"><span>visual test</span>
                <span class="nav-arrow"><svg width="8" height="8" viewBox="0 0 14 14" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="css-15v2m24 e1skfx024">
                        <path
            ...
            <div class="nav-item"> <span>enterprise</span>
                <span class="nav-arrow"><svg width="8" height="8" viewBox="0 0 14 14" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="css-15v2m24 e1skfx024">
                        <path
                            d="M12.096 8.768V2.404a.5.5 0 00-.5-.5H5.232a.5.5 0 100 1h5.157L2.05 11.243a.5.5 0 10.707.707l8.34-8.34v5.158a.5.5 0 101 0z"
        ...
        <div class="nav-right">
            <div class="nav-right-item"><span><svg viewBox="0 0 16 16" width="14" height="14"
                        class="octicon octicon-mark-github css-1cu6crl eo8x3zi2" aria-hidden="true">
            ...
            <div class="nav-right-item"> <span><svg width="20" height="20" class="DocSearch-Search-Icon" viewBox="0 0 20 20"
                        aria-hidden="true">
                        <path
